...
export default function Home() {
  ...
  function handleAreaFormSubmit(event) {
    ...
    const url = `http://127.0.0.1:8000/shop/near-me?coords=${location[0]},${
      location[1]
    }&categories=${filter.clothandshoe ? "CLOTHANDSHOE" : null},${
                      ...
                      <FormControl component="fieldset">
                        ...
                        <FormGroup aria-label="position">
                            ...
                            control={
                              <Checkbox
                                ...
                                onChange={() => {
                                  setFilter({
                                    ...filter,
                                    clothandshoe: !filter.clothandshoe,
                                  });
                                }}
                              />
                            }
                          ...
                          <FormControlLabel
                            value="FOOD"
                            control={
                              <Checkbox color="primary" checked={filter.food} />
                            }
                            label="Food"
                            labelPlacement="end"
                            onChange={() => {
