            ...
            <div>
              ...
              >
                <Marker
                  ...
                  longitude={deliveryManLocation[0]}
                >
                  <RoomIcon style={{ fontSize: "2rem" }} color="primary" />
                </Marker>
                <Marker latitude={shopLocation[1]} longitude={shopLocation[0]}>
                  <RoomIcon style={{ fontSize: "3rem", color: "red" }} />
                </Marker>
              </ReactMapGL>
            </div>
          </DialogContent>
                        ...
                        >
                          ...
                          >
                            <Grid container spacing={2}>
                              <Grid item xs={6}>
                                <Typography>
                                  Order for {shopWithProducts.name}
                                </Typography>
                              </Grid>
                              <Grid item xs={2}>
                                <Button
                                  variant="text"
                                  classes={
                                    shopWithProducts.products.deliveryStatus ===
                                    "pending"
                                      ? {
                              ...
                              <Grid item xs={2}>
                                <Button
                                  ...
                                  color="primary"
                                  onClick={() =>
                                    handleOpenMap(shopWithProducts.coordinates)
                                  }
                                >
                                  Open Shop Location
                                </Button>
                          ...
                          <AccordionDetails>
                            ...
                            <TableContainer>
                              ...
                              >
                                ...
                                <TableBody>
                                  {shopWithProducts.products.products.map(
                                    (product) => (
                                      <TableRow
